...
CREATE TYPE "public"."feedback_category" AS ENUM('general', 'bug', 'feature', 'usability', 'performance');--> statement-breakpoint
CREATE TYPE "public"."org_member_role" AS ENUM('owner', 'admin', 'editor', 'viewer');--> statement-breakpoint
CREATE TABLE "users" (
